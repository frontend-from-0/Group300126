...
// Expected output: [1, 2, 3, 4, 5, 5, 5, 6, 9, 33, 110]
...
const peopleByAge = [...people].sort((personA, personB) => personA.age - personB.age);
...
const wordsByLength = [...words].sort((wordA, wordB) => wordA.length - wordB.length);
