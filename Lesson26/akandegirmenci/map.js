...
const squaredNumbers = numbersExercise2.map((number) => number ** 2);
...
const numbersAsStrings = numbersExercise6.map((number) => number.toString());
...
const sentenceWords = sentencesExercise7.map((sentence) => sentence.split(' '));
