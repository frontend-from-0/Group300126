...
const wordsWithA = wordsExercise2.filter((word) => word.includes("a"));
...
const usersAtLeast25 = usersExercise4.filter((user) => user.age >= 25);
console.log(usersAtLeast25);
...
const multiplesOfThree = numbersExercise7.filter((number) => number % 3 === 0);
...
const usersStartingWithJ = usersExercise10.filter((user) =>
